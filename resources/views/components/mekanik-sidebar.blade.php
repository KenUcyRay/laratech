<div class="h-100 pt-0" style="background: linear-gradient(180deg, #1e40af 0%, #0891b2 100%); box-shadow: 2px 0 10px rgba(0,0,0,0.1); height: 100vh; overflow-y: auto;">
    ...
    <div class="p-4 border-bottom border-white border-opacity-25">
        <div class="d-flex align-items-center text-white">
            <i class="fas fa-wrench fs-4 me-3" style="color: rgba(255,255,255,0.9);"></i>
            <div>
                <h6 class="mb-0 fw-bold">Mekanik Panel</h6>
            ...
            <li class="nav-item">
                <a class="nav-link text-white d-flex align-items-center py-3 px-3 rounded-3 {{ request()->routeIs('mekanik.inventory*') ? 'active' : '' }}" 
                   ...
                   onmouseout="if(!this.classList.contains('active')) this.style.background='transparent'">
                    ...
                    <span class="fw-medium">Inventori Spare Part</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white d-flex align-items-center py-3 px-3 rounded-3 {{ request()->routeIs('mekanik.reports*') ? 'active' : '' }}" 
                   ...
                   onmouseout="if(!this.classList.contains('active')) this.style.background='transparent'">
                    ...
                    <span class="fw-medium">Laporan Kerja</span>
                </a>
            </li>
        </ul>
    </div>
