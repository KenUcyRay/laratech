            ...
            <div class="col-xl-6 col-md-6">
                <div class="card border-0 shadow-lg rounded-4 h-100"
                    ...
                    <div class="card-body p-4 text-center">
                        ...
                        <h3 class="fw-bold text-white mb-1">{{ $operators->total() }}</h3>
            ...
            <div class="col-xl-6 col-md-6">
                <div class="card border-0 shadow-lg rounded-4 h-100"
                    ...
                    <div class="card-body p-4 text-center">
                        ...
                        <h3 class="fw-bold text-white mb-1">{{ $mekaniks->total() }}</h3>
        ...
        <div class="card border-0 shadow-lg rounded-4 mb-4"
            ...
            <div class="card-header bg-transparent border-0 p-4">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-success rounded-pill fs-6">{{ $operators->total() }} members</span>
                </div>
            </div>
            <div class="card-body p-4">
                        ...
                        <tbody>
                            @foreach($operators as $operator)
                                <tr class="border-0">
                                    ...
                                    <td class="py-3">
                                        <span
                                            class="badge bg-primary rounded-pill px-3 py-2">{{ $operator->total_tasks }}</span>
                                    </td>
                                    <td class="py-3">
                                        <span
                                            class="badge bg-warning rounded-pill px-3 py-2">{{ $operator->pending_tasks }}</span>
                                    </td>
                                    <td class="py-3">
                                        <span
                                            class="badge bg-success rounded-pill px-3 py-2">{{ $operator->completed_tasks }}</span>
                                    </td>
                                    <td class="py-3">
                                        @php
                                        ...
                                        <div class="progress rounded-pill shadow-sm" style="height: 25px; width: 120px;">
                                            <div class="progress-bar rounded-pill fw-semibold
                                                                ...
                                                                @else bg-danger @endif" style="width: {{ $performance }}%">
                                                {{ $performance }}%
                                            </div>
                                        </div>
                                    </td>
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <div class="text-muted small">
                        Showing {{ $operators->firstItem() ?? 1 }} to {{ $operators->lastItem() ?? $operators->count() }} of
        ...
        <div class="card border-0 shadow-lg rounded-4"
            ...
            <div class="card-header bg-transparent border-0 p-4">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-warning rounded-pill fs-6">{{ $mekaniks->total() }} members</span>
                </div>
            </div>
            <div class="card-body p-4">
                <div class="table-responsive">
                        ...
                        <tbody>
                            @foreach($mekaniks as $mekanik)
                                <tr class="border-0">
                                    ...
                                    <td class="py-3">
                                        <span
                                            class="badge bg-warning rounded-pill px-3 py-2">{{ $mekanik->pending_tasks }}</span>
                                    </td>
                                    <td class="py-3">
                                        <span
                                            class="badge bg-success rounded-pill px-3 py-2">{{ $mekanik->completed_tasks }}</span>
                                    </td>
                                    <td class="py-3">
                                        @php
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <div class="text-muted small">
                        Showing {{ $mekaniks->firstItem() ?? 1 }} to {{ $mekaniks->lastItem() ?? $mekaniks->count() }} of
                        {{ $mekaniks->total() }} results
                    </div>
                    <div class="d-flex align-items-center gap-2">
