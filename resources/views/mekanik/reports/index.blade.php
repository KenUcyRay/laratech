...
@section('content')
    ...
    @push('scripts')
        <script>
                                ...
                                <div class="custom-popup">
                                    ...
                                    <div class="custom-popup-body">
                                        ...
                                        <div class="custom-popup-buttons">
                                            <button class="custom-popup-btn custom-popup-btn-primary" onclick="this.closest('.custom-popup-overlay').remove()">OK</button>
                                        </div>
                                    </div>
                                </div>
                            `;
            ...
            function showConfirm(title, text, confirmText = 'Ya, lanjutkan!', cancelText = 'Batal') {
                return new Promise((resolve) => {
                    const overlay = document.createElement('div');
                    overlay.className = 'custom-popup-overlay';
                    overlay.innerHTML = `
                                <div class="custom-popup">
                                    ...
                                    <div class="custom-popup-body">
                                        <p class="custom-popup-text">${text}</p>
                                        <div class="custom-popup-buttons">
                                            <button class="custom-popup-btn custom-popup-btn-secondary" data-action="cancel">${cancelText}</button>
                                            <button class="custom-popup-btn custom-popup-btn-primary" data-action="confirm">${confirmText}</button>
                                        </div>
                                    </div>
                                </div>
                            `;
            ...
            document.querySelectorAll('.create-task-btn').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    showConfirm('Create Task?', 'Create a generic repair task for this report?', 'Yes, create it!', 'Cancel').then((result) => {
