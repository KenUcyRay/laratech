                                ...
                                <div class="col-md-4">
                                    <div class="card border-0 shadow-sm rounded-4 h-100">
                                        <div class="card-body p-4 text-center">
                                            ...
                                            <h2 class="fw-bold text-primary mb-2">${todaySchedules.length}</h2>
                                            <p class="text-muted mb-0 fw-semibold">Jadwal Hari Ini</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card border-0 shadow-sm rounded-4 h-100">
                                        <div class="card-body p-4 text-center">
                                            ...
                                            <h2 class="fw-bold text-warning mb-2">${maintenanceCount}</h2>
                                            <p class="text-muted mb-0 fw-semibold">Total Maintenance</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card border-0 shadow-sm rounded-4 h-100">
                                        <div class="card-body p-4 text-center">
                                            ...
                                            <h2 class="fw-bold text-info mb-2">${taskCount}</h2>
                                            <p class="text-muted mb-0 fw-semibold">Total Tasks</p>
                                        </div>
                                    </div>
                                </div>
                            `;
